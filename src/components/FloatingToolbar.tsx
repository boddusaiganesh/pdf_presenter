    ...
    <>
      ...
      <div className="flex items-center gap-1 px-3 py-2 rounded-2xl glass border border-white/[0.1] shadow-2xl shadow-black/50 select-none">
          ...
          {activeSection === 'draw' && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 glass rounded-2xl p-3 shadow-2xl border border-white/[0.08] z-50 animate-fade-in w-max">
              ...
              <div className="flex items-center gap-2 px-1">
                ...
                <div className="relative">
                  <div
                    className="w-5 h-5 rounded-full border-2 border-white/30 cursor-pointer overflow-hidden"
              ...
              <div className="mt-3 px-1 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    type="range" min="0.1" max="1" step="0.1" value={drawOpacity}
              ...
              <div className="flex gap-1 mb-3">
                {pointerModes.map((p) => (
                  <ToolbarButton
                    ...
                    label={p.label}
                    shortcut={p.shortcut}
                    onClick={() => setPointerMode(p.mode)}
                    active={pointerMode === p.mode}
                  />
                ))}
              </div>
        ...
        <ToolbarButton
          ...
          label={isBlackScreen ? 'Show Slide' : 'Black Screen'}
          shortcut="B"
        ...
        <ToolbarButton
          ...
          label={isFrozen ? 'Unfreeze Canvas' : 'Freeze Canvas'}
          shortcut="Z"
        ...
        <div className="relative">
          ...
          {showTimerPanel && (
            <div className="absolute bottom-full right-0 mb-3 glass rounded-2xl p-4 shadow-2xl border border-white/[0.08] z-50 animate-fade-in w-56">
              ...
              <div className={cn('text-3xl font-mono text-center mb-4', td.color)}>
                {td.text}
              </div>
      ...
      {showTimerPanel && (
        <div className="fixed inset-0 z-40" onClick={() => setShowTimerPanel(false)} />
      )}
    </>
  );
}
